      ...
      let displayArray = [
          ...
          (
            <div className="signup_section">
              ...
              <div className="wine_instructions">
                "Same as with wine, we suggest keeping an open mind, especially if you’ve never heard of or tasted a particular type of beer. Let us pair it with a dish that’ll really wow you. If you just can’t stand a hoppy beer, or if stouts are not your thing, that’s perfectly ok. Simply select the beers you DON'T want us to show you."
              </div>
